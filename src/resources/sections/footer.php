    ...
    if(CLIENT_MODE_ENABLED == false)
    {
        ...
        <footer class="footer">
            <div class="container-fluid clearfix">
                <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © 2018-<?PHP HTML::print(date('Y')); ?> <a href="https://intellivoid.info/">Intellivoid</a>. All rights reserved.</span>
