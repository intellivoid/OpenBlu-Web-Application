                                            ...
                                            <div class="col-12">
                                                <div class="preview-list">
                                                    ...
                                                    <?PHP
                                                        ...
                                                        foreach($PopularServers as $VPNArray)
                                                        {
                                                            $VPN = VPN::fromArray($VPNArray);
                                                            ?>
                                                            <div class="preview-item border-bottom" onclick="location.href='/server?pub_id=<?PHP HTML::print($VPN->PublicID) ?>';">
